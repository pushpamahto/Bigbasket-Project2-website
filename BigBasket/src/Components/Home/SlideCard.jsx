  ...
  render() {
    ...
    return (
      <Box h={'auto'} w='100%' m={'auto'} mt='140px' mb="15px" >
        ...
        <Slider {...settings}>
        <Box>
           <Image src='https://www.bigbasket.com/media/uploads/banner_images/B2C051810583-19877-4june24.jpg?tr=w-1920,q=80' w='100%' h={['200','400','500']} />
           </Box>
           <Box>
            <Image src='https://www.bigbasket.com/media/uploads/banner_images/B2C051810583-19878-6june24.jpg?tr=w-1920,q=80' w='100%' h={['200','400','500']}/>
          </Box>
          <Box>
