...
import BBlogo from '../../src/BBlogo.png'
        ...
        <div>
            ...
            <div id="sec">
                <div id="category">
                    <span id="shop">SHOP BY CATEGORY
                        ...
                        <div className="dropdown__menu">
                            <ul>
                                <NavLink to="/Fruites&Vegetables">  <li type="none" className="list">Fruits & Vegetables
                ...
                <div id="offer">
                    ...
                    <span>Exotic Fruit & Vegetable</span>
                </div>
